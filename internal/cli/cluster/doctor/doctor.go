...
func doctorCheckSpecs(kubectl core.KubectlRunner, distro Distribution) []doctorCheckSpec {
	return []doctorCheckSpec{
		...
		{Name: "operator registry endpoint", Detail: "checking the operator uses an internal registry pull endpoint instead of the public registry ingress host", Run: func() DoctorCheck { return checkOperatorRegistryEndpoint(kubectl) }},
