...
| `/api/v1/runtime/grants`                                 | POST          | 401  | 200/403/422/503 | 200/403/422/503 | 200/422/503 | 401/403 | Create/update requires admin, server owner, or team owner; agent subjects must be active directory entries in the subject team. |
