...
- L50-L57: `initCommands` attaches the cluster, registry, server, setup, status, and pipeline subcommands provided by `internal/cli` packages using the shared logger.
